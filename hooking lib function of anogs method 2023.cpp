...
#### THIS BELOW THREADS CAN BE FOUND VIA IDA PRO LIVE DEBUGGING METHODS SO DONT BE FINDING OR ##
 ###WAST OF UR TIME TO FINDING THIS IN LIB OHK SO SEE ONLY THIS THREADS CAN RUN WHEN GAMES CAN START THAT TIME####
